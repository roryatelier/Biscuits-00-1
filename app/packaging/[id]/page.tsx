...
const PACKAGING = {
  ...
  finish: 'Matte White',
  capacity: '30ml',
  dimensions: '115mm H x 35mm W',
  weight: '18g',
  moq: '5,000 units',
  leadTime: '4–6 weeks',
  supplier: 'Yonwoo Co., Ltd',
  status: 'Active',
  certifications: ['ISO 22716', 'FSC (carton)', 'BPA-free'],
  variants: [
    { id: 'bottle', label: 'Bottle', icon: '⬡', active: true },
    { id: 'tube',   label: 'Tube',   icon: '▭', active: false },
    { id: 'jar',    label: 'Jar',    icon: '⬠', active: false },
  ],
  colors: ['Matte White', 'Matte Black', 'Frosted Clear', 'Custom'],
};

const SPECS = [
  { label: 'Format',          value: PACKAGING.format },
  { label: 'Material',        value: PACKAGING.material },
  { label: 'Capacity',        value: PACKAGING.capacity },
  { label: 'Dimensions',      value: PACKAGING.dimensions },
  { label: 'Weight',          value: PACKAGING.weight },
  { label: 'Finish',          value: PACKAGING.finish },
  { label: 'MOQ',             value: PACKAGING.moq },
  { label: 'Lead time',       value: PACKAGING.leadTime },
  { label: 'Supplier',        value: PACKAGING.supplier },
  { label: 'Certifications',  value: PACKAGING.certifications.join(', ') },
];
...
export default function PackagingDetailPage() {
  ...
  const [selectedFormat, setSelectedFormat] = useState('bottle');
        ...
        <div className={styles.header}>
          <div className={styles.headerLeft}>
            <div className={styles.headerMeta}>
              <span className={styles.formatBadge}>{PACKAGING.format}</span>
              <span className={styles.statusBadge}>{PACKAGING.status}</span>
            </div>
            <h1 className={styles.title}>{PACKAGING.name}</h1>
            <p className={styles.subtitle}>{PACKAGING.material} · {PACKAGING.finish} · MOQ {PACKAGING.moq}</p>
          </div>
          ...
          <div className={styles.tabContent}>
            <div className={styles.orderInfo}>
              <div className={styles.orderCard}>
                ...
                <p className={styles.orderCardValue}>{PACKAGING.moq}</p>
              ...
              <div className={styles.orderCard}>
                <h3 className={styles.orderCardTitle}>Sample available</h3>
                <p className={styles.orderCardValue}>Yes</p>
                <p className={styles.orderCardSub}>Blank samples within 1–2 weeks</p>
              </div>
            </div>
