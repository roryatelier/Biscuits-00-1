...
async function main() {
  ...
  const aosSuppliers = [
    ...
    { id: 'aos_06', companyName: 'Ancorotti Cosmetics',  qualificationStage: 'Fully Qualified', categories: ['colour'], subcategories: ['Foundation', 'Lip', 'Eye', 'Blush'], capabilityType: 'turnkey', capabilities: { fillTypes: ['bottle', 'jar', 'stick', 'compact'], fillVolumeMin: 3, fillVolumeMax: 50, packagingMaterials: ['PP', 'Aluminium', 'Glass'], whiteLabel: true }, moq: 15000, keyBrands: ['MAC', 'Urban Decay'], companyCity: 'Crema', companyCountry: 'Italy', factoryCity: 'Crema', factoryCountry: 'Italy', customSampleLeadTimeDays: 21, productionLeadTimeDays: 42, samplePriceMin: 4.00, samplePriceMax: 12.00, cautionFlag: false, cautionNote: null, cobaltEnabled: true },
  ...
  const briefAssignments = [
    ...
    { id: 'sba_04', aosSupplierId: 'aos_01', supplierBriefId: 'sb_02', matchScore: 50, matchBreakdown: { GMP: true, FDA: true }, status: 'assigned', assignedById: userId },
